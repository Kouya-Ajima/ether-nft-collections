...
const TWITTER_HANDLE = 'koya';
const TWITTER_LINK = `https://twitter.com/${TWITTER_HANDLE}`;
const OPENSEA_LINK = 'https://testnets.opensea.io/assets';
const TOTAL_MINT_COUNT = 50;

// コントラクトアドレスをCONTRACT_ADDRESS変数に格納
const CONTRACT_ADDRESS = '0x58322500dd4BAB324370ec99FF860C0B9784Ad9B';
...
const App = () => {
    ...
    const renderSoldOutUI = () => (
        <button onClick={null} className='cta-button soldout-button'>
            SOLD OUT
        </button>
    );
                ...
                <div className='middle-container'>
                    <button className='opensea-button'>
                        <a
                            ...
                            href='https://testnets.opensea.io/koya'
                            target='_blank'
                            rel='noreferrer'
                        >
                            OpenSeaでコレクションを表示
